            ...
            <div class="footer__contact">
                ...
                <ul class="footer__list">
                    <li class="footer_item">
                        <address class="text"> 55 East Birchwood Ave. Brooklyn, New York 11201
                        </address>
                    </li>
                    <li class="footer_item">
                        <address>
                            <a class="text" href="mailto:contact@interno.com">contact@interno.com</a>
                        </address>
                    </li>
                    <li class="footer_item">
                        <address>
                            <a class="text" href="tel:+7(123)4567890">(123) 456 - 7890</a>
                        </address>
                    </li>
                </ul>
            </div>
